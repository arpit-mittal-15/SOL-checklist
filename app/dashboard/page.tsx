...
export default function Dashboard() {
  ...
  // Scheduled email check (runs every minute to check if it's 3:50 PM IST)
  useEffect(() => {
    const checkScheduledEmail = async () => {
      ...
      // Check if it's exactly 3:50 PM IST
      if (currentHour === 15 && currentMinute === 50) {
        try {
          console.log('🕒 Scheduled email time detected (3:50 PM IST). Triggering scheduled email...');
