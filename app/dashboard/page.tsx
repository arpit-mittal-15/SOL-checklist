...
export default function Dashboard() {
  ...
  // Scheduled email check (runs every minute to check if it's 3:55 PM IST)
  useEffect(() => {
    const checkScheduledEmail = async () => {
      ...
      // Check if it's exactly 3:55 PM IST
      if (currentHour === 15 && currentMinute === 55) {
        try {
          console.log('🕒 Scheduled email time detected (3:55 PM IST). Triggering scheduled email...');
